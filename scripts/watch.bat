...
set OBSIDIAN_DIR=c:\Users\User\Desktop\Obsidian
...
set "WATCH_DIRS=%BKB_DIR% %QUARTZ_DIR%\data\config.yaml %QUARTZ_DIR%\config.toml %QUARTZ_DIR%\assets\js %QUARTZ_DIR%\assets\styles %QUARTZ_DIR%\layouts  %QUARTZ_DIR%\static "
